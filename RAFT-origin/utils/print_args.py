def print_args(args):
    ...
    print(f'  {"Topm:":<20}{args.topm:<20}{"Retr Temp:":<20}{args.retrieval_temperature:<20}')
    print(f'  {"Meta-Only Retr:":<20}{args.meta_only_retrieval:<20}{"Cmp Retr Quality:":<20}{args.compare_retrieval_future_quality:<20}')
    print()

...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--retrieval_temperature', type=float, default=0.1,
        help='temperature for top-m retrieval weighting'
    )
    parser.add_argument(
        '--meta_only_retrieval', action='store_true', default=False,
        help='use channel-wise meta retrieval instead of block-wise wave retrieval'
    )
    parser.add_argument(
        '--compare_retrieval_future_quality', action='store_true', default=False,
        help='evaluate wave-only vs meta-only retrieval future quality on test split'
    )

...
class Exp_Long_Term_Forecast(Exp_Basic):
    ...
    def _unpack_batch(batch):
        ...
        meta_text_by_period = batch[7] if len(batch) > 7 else None
        return index, batch_x, batch_y, batch_x_mark, batch_y_mark, meta_data, meta_text, meta_text_by_period
    ...
    def vali(self, vali_data, vali_loader, criterion, split_mode='valid'):
        ...
        with torch.no_grad():
            for i, batch in enumerate(vali_loader):
                index, batch_x, batch_y, batch_x_mark, batch_y_mark, meta_data, meta_text, meta_text_by_period = self._unpack_batch(batch)
